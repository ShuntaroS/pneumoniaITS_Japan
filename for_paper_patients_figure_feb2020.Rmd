---
title: "Analysis for Monthly hospitalizaions (Figure)"
...
here::i_am("Script/for_paper/for_paper_patients_figure_feb2020.Rmd")
```
...
predict_plot <- function(pred.data, vars1) {
  plot <- pred.data %>%
    ...
    annotate("rect", xmin = as.Date("2020-02-01"), xmax = as.Date("2020-08-01"), ymin = 0, ymax = Inf,
             alpha = 0.4, fill = "gray") +
    geom_point(aes(y = n), color = "#0099b4", alpha = 0.5) +
...
ggsave(here("Script", "for_paper", "figure", "Pneumonia.pdf"), plot = plots[[1]], dpi = 300, width = 6, height = 6*0.5)
ggsave(here("Script", "for_paper", "figure", "Pyelonephritis.pdf"), plot = plots[[2]], dpi = 300, width = 6, height = 6*0.5)
ggsave(here("Script", "for_paper", "figure", "Biliary _tract_infections.pdf"), plot = plots[[3]], dpi = 300, width = 6, height = 6*0.5)
```
...
ggsave(here("Script", "for_paper", "figure", "Pneumonia_n_18to64_feb.pdf"), plot = plots[[1]], dpi = 300, width = 6, height = 6*0.5)
ggsave(here("Script", "for_paper", "figure", "Pneumonia_n_65_feb.pdf"), plot = plots[[2]], dpi = 300, width = 6, height = 6*0.5)
```
...
ggsave(here("Script", "for_paper", "figure", "Pneumococca_n_18to64_feb.pdf"), plot = plots[[1]], dpi = 300, width = 6, height = 6*0.5)
ggsave(here("Script", "for_paper", "figure", "Pneumococca_n_65.pdf_feb.pdf"), plot = plots[[2]], dpi = 300, width = 6, height = 6*0.5)
ggsave(here("Script", "for_paper", "figure", "Aspiration_n_18to64_feb.pdf"), plot = plots[[3]], dpi = 300, width = 6, height = 6*0.5)
ggsave(here("Script", "for_paper", "figure", "Aspiration_n_65_feb.pdf"), plot = plots[[4]], dpi = 300, width = 6, height = 6*0.5)
ggsave(here("Script", "for_paper", "figure", "Influenza_n_18to64_feb.pdf"), plot = plots[[5]], dpi = 300, width = 6, height = 6*0.5)
ggsave(here("Script", "for_paper", "figure", "Influenza_n_65_feb.pdf"), plot = plots[[6]], dpi = 300, width = 6, height = 6*0.5)
